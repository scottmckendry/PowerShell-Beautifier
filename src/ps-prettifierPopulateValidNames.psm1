...
#region Function: Update-RegenerateLookupTableValuesFile
...
Gets lookup values currently in memory and saves cache file.
#>
function Update-RegenerateLookupTableValuesFile {
    #region Function parameters
    [CmdletBinding(SupportsShouldProcess, ConfirmImpact = 'Low')]
    param()
    #endregion
...
Export-ModuleMember -Function Update-RegenerateLookupTableValuesFile
#endregion
...
function Invoke-Main {
    ...
    process {
        ...
        [string]$script:ValidValuesCacheFilePath = Join-Path -Path $PSScriptRoot -ChildPath "PrettifierValidValuesCache.txt"
        ...
        if ($true -eq (Test-Path -Path $ValidValuesCacheFilePath)) {
            ...
            Update-RegenerateLookupTableValuesFile
        }
    }
}
#endregion
